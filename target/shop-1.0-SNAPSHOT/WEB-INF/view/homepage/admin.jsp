        ...
        <div id="sequence" class="seq">
            <div class="seq-screen">
                <ul class="seq-canvas">
                    ...
                    <li>
                        <div class="seq-model">
                            <img data-seq src="<c:url value="/templatesecond/img/slider/1.jpg"/>" alt="Men slide img" />
                        </div>
                        <div class="seq-title">
                    ...
                    <li>
                        <div class="seq-model">
                            <img data-seq src="<c:url value="/templatesecond/img/slider/2.jpg"/>" alt="Wristwatch slide img" />
                        </div>
                        <div class="seq-title">
                    ...
                    <li>
                        <div class="seq-model">
                            <img data-seq src="<c:url value="/templatesecond/img/slider/3.jpg"/>" alt="Women Jeans slide img" />
                        </div>
                        <div class="seq-title">
                            <span data-seq>Save Up to 75% Off</span>
