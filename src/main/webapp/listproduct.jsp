                        ...
                        <div class="aa-product-catg-head-left">
                            <form action="" class="aa-sort-form">
                                ...
                                <select name="">
                                    ...
                                    <option value="2" selected="a">Name</option>
                    ...
                    <div class="aa-product-catg-body">
                        <ul class="aa-product-catg">
                            ...
                            <li>
                                ...
                                <!-- product badge -->
                                <span class="aa-badge aa-sold-out" href="#"><%=rs.getString(7) %></span>
                            </li>
                            <%
                                }
                            %>
                ...
                <aside class="aa-sidebar">
                    ...
                    <div class="aa-sidebar-widget">
                        ...
                        <ul class="aa-catg-nav">
                            <li><a href="">Men</a></li>
                            <li><a href="/category?action=2f">Women</a></li>
                            <li><a href="">Kids</a></li>
                            <li><a href="">Shoes</a></li>
                            <li><a href="">Bags</a></li>
                        </ul>
                    ...
                    <div class="aa-sidebar-widget">
                        ...
                        <div class="aa-sidebar-price-range">
                            <form action="">
                                <input type="text" size="10" name="giat">-
                                -<input type="text" size="10" name="giac">
                                <hr>
