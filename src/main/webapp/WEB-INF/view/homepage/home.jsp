                    ...
                    <div class="aa-product-area">
                        <div class="aa-product-inner">
                            ...
                            <ul class="nav nav-tabs aa-products-tab">
                                ...
                                <li><a href="/category?action=2" data-toggle="tab">Women</a></li>
                                <li><a href="/category?action=3" data-toggle="tab">Kids</a></li>
                                <li><a href="/category?action=4" data-toggle="tab">Shoes</a></li>
                                <li><a href="/category?action=5" data-toggle="tab">Bags ${sql}</a></li>
                            </ul>
                            <!-- Tab panes -->
                                ...
                                <div class="tab-pane fade in active" id="men">
                                    <ul class="aa-product-catg">
                                        ...
                                        <%
                                            ...
                                            ResultSet rs = con.chonDuLieuTuDTB("select * from sanpham where idMenuCon=1");
                                        %>
                                        ...
                                        %>
                                            <li>
                                                ...
                                                <!-- product badge -->
                                                <span class="aa-badge aa-sale" href="#"><%=rs.getString(7) %></span>
                                            </li>
                                        <%
                                            }
                                        %>
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="aa-banner-area">
                        <a href="#"><img src="<c:url value="/templatesecond/img/fashion-banner.jpg"/>" alt="fashion banner img"></a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade in active" id="popular">
                                <ul class="aa-product-catg aa-popular-slider">
                                    ...
                                    <li>
                                        <figure>
                                            <a class="aa-product-img" href="#"><img src="<c:url value="/templatesecond/img/man/polo-shirt-2.png"/>" alt="polo shirt img"></a>
                                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                                            <figcaption>
                                    ...
                                    <li>
                                        <figure>
                                            <a class="aa-product-img" href="#"><img src="<c:url value="/templatesecond/img/man/t-shirt-1.png"/>" alt="polo shirt img"></a>
                                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                                        </figure>
                                        <figcaption>
